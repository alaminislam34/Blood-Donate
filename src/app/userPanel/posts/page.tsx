...
const dummyPosts: Post[] = [
  {
    ...
    content:
      "It was amazing to help someone in need. I encourage everyone to donate blood!",
  ...
  },
  {
    ...
    content:
      "Drink plenty of water and eat a healthy meal before donating blood. Rest well too!",
...
export default function MyPostsPage() {
  ...
  return (
    <div className="w-full mx-auto p-6 bg-white rounded-lg shadow">
      <h1 className="text-2xl font-bold mb-6 text-gray-900 ">My Posts</h1>

      {posts.length === 0 ? (
        <p className="text-gray-700 ">You have not made any posts yet.</p>
      ) : (
